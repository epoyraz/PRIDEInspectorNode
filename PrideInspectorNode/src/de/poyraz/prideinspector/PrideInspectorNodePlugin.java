 ...
 * @author Enes Poyraz
 */
public class PrideInspectorNodePlugin extends Plugin {
    // The shared instance.
    private static PrideInspectorNodePlugin plugin;

    /**
     * The constructor.
     */
    public PrideInspectorNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static PrideInspectorNodePlugin getDefault() {
        return plugin;
    }
